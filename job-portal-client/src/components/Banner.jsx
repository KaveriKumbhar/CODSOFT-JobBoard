...
const Banner = ({ query, handlInputChange }) => {
  ...
  // const handlInputLocationChange=()=>{

  // }
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
      <h1 className='text-5xl font-bold text-primary mb-3'>Find Your <span className='text-bla'>New Job </span>Today</h1>
        ...
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
          ...
          {/* <div className='flex md:rounded-s-none rounded shadow-sm ring-1 ring-inset ring-gray-300
            ...
            <input type='text' name='title' id='title' placeholder='Location'
              className='block flex-1 border-0 bg-transparent py-1.5 pl-8 text-gray-900
            placeholder:text-gray-400 focus:right-0 sm:text-sm sm:leading-6' onChange={handlInputLocationChange}
            />
            <FiMapPin className='absolute mt-2.5 ml-2 text-gray-400' />
          </div> */}

          <button className='bg-blue py-2 px-8 text-white md:rounded-s-none'>Search</button>
        </div>
      </form>
